		...
		return (
			<div className="services-editor">
				<div className="row services-editor-row services-editor-row-header">
					...
					<div className="services-editor-col services-editor-col-header col-md-6"></div>
				</div>
	...
	render() {
		...
		return (
			<div>
				...
				<div className="services-editor-col services-editor-col-supplier col-md-6" style={{padding:"10px"}}>
