ProgressArc = React.createClass({
	...
	render() {
	    ...
	    return (
			<div>
				<div style={{padding:0,height:"140px"}}>
					<h5 style={{float:"none"}}>{title}</h5>
                    <div>
						<input type="text" readOnly value={thisMonth} data-max={lastMonth} className="dial m-r-sm" data-fgcolor="#3ca773" data-width="85" data-height="85" />
					</div>
