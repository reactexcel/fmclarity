        ...
        <nav className="navbar navbar-default navbar-fixed-top" role="navigation">
            <div className="container">
                <div className="navbar-header page-scroll">
                    ...
                    <a className="navbar-brand navbar-brand-fm" href={FlowRouter.path('dashboard')}>
                    <span className="fm-title-fm">FM</span>Clarity</a>
                </div>
                <div id="navbar" className="navbar-collapse collapse">
                    <ul className="nav navbar-nav navbar-right">
                        ...
                        <li><a className="page-scroll" href={FlowRouter.path('dashboard')}>Login</a></li>
                    </ul>
                </div>
            </div>
        </nav>
            ...
            <div className="item">
                <div className="container">
                    <div className="carousel-caption blank">
                        <h1>Sed ut perspiciatis <br/>unde omnis iste natus error sit.</h1>
    ...
    <section  className="container features">
        <div className="row">
            <div className="col-lg-12 text-center">
                ...
                <h1>Yada yada yada yada<br/> <span className="navy"> blah blah blah</span> </h1>
