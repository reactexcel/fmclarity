...
AutoInput.MDSelect = React.createClass({
	...
	getInitialState() 
	{
		...
		return { open, items, selectedItem, disabled, errors, readOnly };
	},
	...
	componentWillReceiveProps( props ) 
	{
		...
		this.setState( { items, selectedItem, disabled, errors, readOnly } );
	...
	render() {
		...
		let options = this.props.options || {},
			{ open, items, selectedItem, disabled, readOnly } = this.state,
		...
		return (
                <div 
                    ...
                    <ul className = "dropdown-menu">
                    	<li><div className="helper-text">Here is a message</div></li>
