...
Accounts.urls.enrollAccount = function (token) {
    if(FM.inProduction()) {
      ...
      return Meteor.absoluteUrl('enroll-account/' + token,{rootUrl:"http://52.62.241.82:3000"});
    }
};
...
Accounts.urls.resetPassword = function (token) {
    if(FM.inProduction()) {
      ...
      return Meteor.absoluteUrl('reset-password/' + token,{rootUrl:"http://52.62.241.82:3000"});
    }
};
