		...
		<div className="contact-info">
        	...
        	<div>
                ...
                <ul>
                    ...
                    {billingDetails.streetName ? <li> { billingDetails.streetNumber } { billingDetails.streetName } </li> : null}
                    ...
                    {billingDetails.city ? <li> { billingDetails.city } </li> : null}
